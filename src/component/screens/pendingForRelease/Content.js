            ...
            <div className={"col-md-8"}>
              ...
              <div className={"row originatorInfo"}>
                <div className={"col-md-4 input"}>
                  <InputField
                      ...
                      disabled={true}
                      type={"text"}
                      value={this.props.pendingDocumentInfo.creatorSection || ""}
                  />
                </div>
                <div className={"col-md-4 input"}>
                  <InputField
              ...
              <div className={"tableContainer"}>
                ...
                >
                  ...
                  <tbody>
                  <tr>
                    <td>{this.props.pendingDocumentInfo.creatorSection}</td>
                    <td colSpan={4}>
                      <b>Note:</b>&nbsp;&nbsp;
                      {this.props.pendingDocumentInfo.note}
                    </td>
                  </tr>
                  {this.props.pendingDocumentInfo.destination.map((data, index) => (
                      <tr>
                        <td>{data.office}</td>
