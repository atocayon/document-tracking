...
const rows = [
  {
    id: 1,
    transactionID: "132465",
    subject: "For Approval",
    actionRequired: "Receive",
...
const EnhancedTableToolbar = props => {
  ...
  const color = title === "Incoming Documents" ? "#FDC108":"#4F8AD8";
  return (
    <Toolbar
...
export default function EnhancedTable(props) {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, parseInt(props.rowLength) - page * rowsPerPage);
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={parseInt(props.rowLength)}
            />
            <TableBody>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.actionRequired}</TableCell>
