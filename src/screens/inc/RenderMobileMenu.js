...
export default function RenderMobileMenu (props) {
  ...
  return (
    <Menu
      anchorEl={props.mobileMoreAnchorElMobileMenu}
      anchorOrigin={props.anchorOriginMobileMenu}
      id={props.mobileMenuIdMobileMenu}
      keepMounted
      transformOrigin={props.transformOriginMobileMenu}
      open={props.isMobileMenuOpenMobileMenu}
      onClose={props.handleMobileMenuCloseMobileMenu}
    >
      <MenuItem>
